    ...
    <div class="text-white bg-transparent max-w-[1000px] w-full mx-auto py-20">
      ...
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80">
         <span class="bg-clip-text !text-transparent !bg-gradient-to-r border-b border-b-mkSecondary !from-mkSecondary !to-white  heading5 !text-start">2.  Pricing and Bonus Dynamics:</span>
          Participants will benefit from a structured pricing and bonus system, intended to reward early engagement with the project.
      </p>
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80"> <span class="bg-clip-text !text-transparent !bg-gradient-to-r border-b border-b-mkSecondary !from-mkSecondary !to-white  heading5 !text-start">
         3. Strategic Token Distribution:
      </span>
          A meticulously planned distribution schedule will govern the allocation of tokens purchased during the public sale, ensuring a controlled market release.
      </p>
      <h3 class="bg-clip-text !text-transparent !bg-gradient-to-t !from-mkSecondary !to-white  heading3 px-4 md:px-0 !text-start mt-10">Participation Guidelines</h3>
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80">
      ...
      <h3 class="bg-clip-text !text-transparent !bg-gradient-to-t !from-mkSecondary !to-white  heading3 px-4 md:px-0 !text-start mt-10">Allocation of Raised Funds</h3>
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80">
         <span class="bg-clip-text !text-transparent !bg-gradient-to-r border-b border-b-mkSecondary !from-mkSecondary !to-white  heading5 !text-start">
      ...
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80">
         <span class="bg-clip-text !text-transparent !bg-gradient-to-r border-b border-b-mkSecondary !from-mkSecondary !to-white  heading5 !text-start">2. Marketing and Community Engagement:</span>
          Investments will be made in marketing and community initiatives to encourage adoption and growth.
      </p>
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80">
         <span class="bg-clip-text !text-transparent !bg-gradient-to-r border-b border-b-mkSecondary !from-mkSecondary !to-white  heading5 !text-start">3. Strategic Partnerships and Collaborations:</span>
          A focus on establishing partnerships within the Web3, DeFi, and gaming sectors is a key component of the utilization strategy.
      </p>
      <h3 class="bg-clip-text !text-transparent !bg-gradient-to-t !from-mkSecondary !to-white  heading3 px-4 md:px-0 !text-start mt-10">Security and Compliance Commitment</h3>
      <p class="ml-4 px-4 md:px-0 my-2 leading-relaxed text-white/80">
